    ...
    extend: {
      ...
      colors: {
        ...
        brand: {
          ...
          "red-dark": "hsl(var(--brand-red-dark) / <alpha-value>)",
          gold: "hsl(var(--gold-highlight) / <alpha-value>)",
          "gold-dark": "hsl(var(--gold-warning) / <alpha-value>)",
          green: "hsl(var(--success-green) / <alpha-value>)",
          "green-dark": "hsl(var(--success-green-dark) / <alpha-value>)",
        },
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
